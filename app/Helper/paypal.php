    ...
    function createPlans(){
        ...
        foreach($plans as $plan){
            ...
            ->post(env('PAYPAL_URL').'billing/plans', 
                ...
                [
                    "product_id"=> "PROD-0AT96530RW6034239",
                    'name' => $plan['name'],
...
if (! function_exists('createSubscription')) {
    function createSubscription($planId){
        ...
        $payload = [
            ...
            'subscriber' => [
                'name' => [
                    'given_name' => 'Oluwatobi', //$subscriberDetails['first_name'],
                    'surname' => 'Solomon', //$subscriberDetails['last_name'],
                ],
                'email_address' =>'email@gmail.com', //$subscriberDetails['email'],
            ],
            'application_context' => [
                ...
                'return_url' => url('subscribe'), // Redirect after successful approval
