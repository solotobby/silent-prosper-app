<div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="input-group">
                    <input type="text" wire:model.live="q" class="form-control form-control-alt"
                ...
                @foreach ($stories as $story)
                    <div class="col-md-6 col-xl-4">
                        ...
                        <a class="block block-rounded bg-image h-100 mb-0"
                            style="background-image: url({{ asset('storage/' . $story->img) }});"
                            href="{{ url('show/' . $story->slug) }}">
    ...
    @if (auth()->user()->gender == 'Not-Yet-Decided')
        ...
        <div class="modal fade" id="modal-onboarding" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
