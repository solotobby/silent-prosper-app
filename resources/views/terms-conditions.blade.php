		...
		<div class="row">
			<div class="col-lg-7 m-auto">
				<div class="heading1">
					...
					<h5 class="mt-2">User-Generated Content</h5>
					<p class="mt-6"> 
					...
					<h5 class="mt-2">Copyright and Intellectual Property</h5>
					<p class="mt-6"> 
                    ...
                    <h5 class="mt-2">Community Guidelines</h5>
					<p class="mt-6"> 
                    ...
                    <h5 class="mt-2">Prohibited Activities</h5>
					<p class="mt-6"> 
                    ...
                    <h5 class="mt-2">Account Termination</h5>
					<p class="mt-6"> 
                    ...
                    <h5 class="mt-2">Changes to Terms</h5>
					<p class="mt-6"> 
