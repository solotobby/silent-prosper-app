                ...
                <div class="row g-0">
                    <div class="col-md-4 col-lg-5 overflow-hidden d-flex align-items-center ">
                        <a href="{{ url('show/' . $story->slug) }}">
                            ...
                            <img class="img-fluid img-link object-cover rounded"
                                src=" {{ asset('storage/' . $story->img) }} " alt="{{ $story->title }}" sizes="10">
                            {{-- <img class="img-fluid img-link" src="{{ asset('src/assets/media/photos/photo19.jpg') }} " alt=""> --}}
                        </a>
                    </div>
                    <div class="col-md-8 col-lg-7 d-flex align-items-centers">
                        <div class="px-4 py-3">
                            <h4 class="mb-1">
                            ...
                            <div class="fs-sm mb-2">
                                <a
                                    href="{{ url('profile/' . $story->user->username) }}">{{ $story->user->id == auth()->user()->id ? 'Me' : $story->user->name }}</a>
                                on {{ $story->created_at->format('M d, Y') }}
                            ...
                            <div class="block-contenlt block-content-fullk mt-2">
                                ...
                                @if ($story->user->id == auth()->user()->id)
                                    <a class="btn btn-alt-secondary" href=""
                                        wire:click="deleteStory({{ $story->id }})" data-bs-toggle="tooltip"
                                        title="Delete Story">
